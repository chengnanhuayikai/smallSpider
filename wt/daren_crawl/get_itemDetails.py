...
def get_rootCategoryId(itemId):
    data = '{"spm":"a21bo.2017.201867-rmds-3.1.5af911d9QXXtSj","scm":"1007.12807.84406.100200300000004","id":"' + str(
        itemId) + '","pvid":"ab900c39-3614-4579-b982-8deb0777f4b6","itemNumId":"' + str(
        itemId) + '","exParams":"{\"spm\":\"a21bo.2017.201867-rmds-3.1.5af911d9QXXtSj\",\"scm\":\"1007.12807.84406.100200300000004\",\"id\":\"' + str(
        itemId) + '\",\"pvid\":\"ab900c39-3614-4579-b982-8deb0777f4b6\"}","detail_v":"8.0.0","utdid":"1"}'
    ...
    response = requests.get('https://api.m.taobao.com/gw/mtop.taobao.detail.getdetail/6.0/?data=' + parse.quote(data),
                          headers=headers)


    info = re.search('"rootCategoryId":"(.*?)",', response.text , re.S)
    # print(response.text)
    if info != None :
        rootCategoryId = info.group(1)
...
if __name__ == '__main__':
    ...
    category = get_rootCategoryId(541368203820) # 570857669382
    print(category)
